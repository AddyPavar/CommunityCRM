...
/*******************************************************************************
 *
 *  filename    : EducationInitiativeReports.php
 *  last change : 2017-11-01
 *  description : form to invoke Education Initiative reports
 *
...
// Get all the education initiative classes
...
$sPageTitle = gettext('Education Initiative Reports');
...
<div class="card">
  ...
  <div class="card-body">
    <form method="post" action="EducationInitiativeReports.php">
      ...
      <table class="table table-simple-padding" align="left">
        ...
        <tr>
          <td><?= gettext('No Education Initiative') ?>:</td>
