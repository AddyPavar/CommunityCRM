...
/*******************************************************************************
*
*  filename    : sundayschol/EducationInitiativeClassListExport.php
*  last change : 2017-11-03 Philippe Logel
*  description : Creates a csv for a Education Initiative Class List
...
header('Content-Disposition: attachment; filename=EducationInitiative-' . date(SystemConfig::getValue('sDateFilenameFormat')) . '.csv');
...
foreach ($groups as $group) {
    ...
    $educationinitiativeClass = $group->getName();
    ...
    foreach ($groupRoleMemberships as $groupRoleMembership) {
        ...
        fputcsv($out, [
            InputUtils::translateSpecialCharset($educationinitiativeClass),
