...
$rsEducationInitiativeClass = RunQuery($sSQL);
while ($aRow = mysqli_fetch_array($rsEducationInitiativeClass)) {
...
$sPageTitle = gettext('Education Initiative') . ': ' . $iGroupName;
...
<div class="card">
  <div class="card-header with-border">
    <h3 class="card-title"><?= gettext('Education Initiative Class Functions') ?></h3>
  </div>
  <div class="card-body">
    <?php
...
<div class="card card-primary">
  ...
  <div class="card-body table-responsive">
    ...
    <table id="educationinitiative" class="table table-striped table-bordered data-table" cellspacing="0" width="100%">
      <thead>
      <tr>
        <th></th>
        <th><?= gettext('Name') ?></th>
