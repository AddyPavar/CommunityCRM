...
abstract class BaseEmail
{
    ...
    {
        $this->setConnection();
        $this->mail->setFrom(CommunityMetaData::getCommunityEmail(), CommunityMetaData::getCommunityName());
    ...
    protected function getCommonTokens(): array
    {
        $commonTokens = [
            ...
            'communityName'           => CommunityMetaData::getCommunityName(),
            'communityAddress'        => CommunityMetaData::getCommunityFullAddress(),
            'communityPhone'          => CommunityMetaData::getCommunityPhone(),
            'communityEmail'          => CommunityMetaData::getCommunityEmail(),
            'communityCRMURL'         => SystemURLs::getURL(),
