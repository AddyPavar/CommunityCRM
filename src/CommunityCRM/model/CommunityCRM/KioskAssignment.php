...
use CommunityCRM\dto\KioskAssignmentTypes;
use CommunityCRM\model\CommunityCRM\Base\KioskAssignment as BaseKioskAssignment;
use CommunityCRM\model\CommunityCRM\Map\ListOptionTableMap;
