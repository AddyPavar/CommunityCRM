...
use CommunityCRM\model\CommunityCRM\Base\Group as BaseGroup;
...
{
    protected $typeEducationInitiative = 4;

    public function isEducationInitiative(): bool
    {
        return $this->getType() == $this->typeEducationInitiative;
    }

    public function makeEducationInitiative(): void
    {
        $this->setType($this->typeEducationInitiative);
    }
