...
namespace CommunityCRM\model\CommunityCRM;

use CommunityCRM\dto\SystemConfig;
use CommunityCRM\model\CommunityCRM\Base\Deposit as BaseDeposit;
use CommunityCRM\model\CommunityCRM\Map\DonationFundTableMap;
use CommunityCRM\model\CommunityCRM\Map\PledgeTableMap;
use CommunityCRM\model\CommunityCRM\PledgeQuery as ChildPledgeQuery;
...
class Deposit extends BaseDeposit
{
    ...
    public function getOFX(): \stdClass
    {
        ...
        $orgName = 'CommunityCRM Deposit Data';
        ...
        // Export file
        $OFXReturn->header = 'Content-Disposition: attachment; filename=CommunityCRM-Deposit-' . $this->getId() . '-' . date(SystemConfig::getValue('sDateFilenameFormat')) . '.ofx';
    ...
    public function getPDF(): void
    {
        ...
        $Report->pdf = new \CommunityCRM\Reports\PdfDepositReport();
        ...
        // Export file
        $Report->pdf->Output('CommunityCRM-DepositReport-' . $this->getId() . '-' . date(SystemConfig::getValue('sDateFilenameFormat')) . '.pdf', 'D');
    }
