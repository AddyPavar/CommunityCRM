...
use CommunityCRM\Backup\BackupType;
...
class SystemService
{
    private const COMPOSER_NAME = 'communitycrm/crm';
    ...
    public static function runTimerJobs(): void
    {
        ...
        if (self::isTimerThresholdExceeded(SystemConfig::getValue('sLastSoftwareUpdateCheckTimeStamp'), SystemConfig::getValue('iSoftwareUpdateCheckInterval'))) {
            ...
            // Inside CommunityCRMReleaseManager, the restults are stored to the $_SESSION
            CommunityCRMReleaseManager::checkForUpdates();
            $now = new \DateTime();  // update the LastBackupTimeStamp.
