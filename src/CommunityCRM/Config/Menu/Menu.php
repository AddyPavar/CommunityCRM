...
namespace CommunityCRM\Config\Menu;
...
class Menu
{
    ...
    private static function buildMenuItems(): array
    {
        return [
            ...
            'EducationInitiative' => self::getEducationInitiativeMenu(),
    ...
    private static function getEducationInitiativeMenu(): MenuItem
    {
        $sundaySchoolMenu = new MenuItem(gettext('Education Initiative'), '', SystemConfig::getBooleanValue('bEnabledEducationInitiative'), 'fa-child');
        $sundaySchoolMenu->addSubMenu(new MenuItem(gettext('Dashboard'), 'educationinitiative/EducationInitiativeDashboard.php'));
        // now we're searching the unclassified groups
        $tmpMenu = self::addGroupSubMenus(gettext('Classes'), 4, 'educationinitiative/EducationInitiativeClassView.php?groupId=');
        if ($tmpMenu instanceof MenuItem) {
    ...
    private static function getEventsMenu(): MenuItem
    {
        ...
        $eventsMenu->addSubMenu(new MenuItem(gettext('Add Community Event'), 'EventEditor.php', AuthenticationManager::getCurrentUser()->isAddEventEnabled()));
        $eventsMenu->addSubMenu(new MenuItem(gettext('List Community Events'), 'ListEvents.php'));
