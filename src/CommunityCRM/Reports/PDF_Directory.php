...
class PdfDirectory extends CommunityInfoReport
{
    // Private properties
    ...
    public $_PS = 'Letter';
    public $sSortBy = '';
    private string $sCommunityNameEncoded;
    private string $sCommunityAddressEncoded;
    private string $sCommunityCityEncoded;
    private string $sCommunityStateEncoded;
    ...
    public function __construct($nc = 1, $paper = 'letter', $fs = 10, $ls = 4)
    {
        ...
        $this->sCommunityNameEncoded = iconv('UTF-8', 'ISO-8859-1', SystemConfig::getValue('sCommunityName'));
        $this->sCommunityAddressEncoded = iconv('UTF-8', 'ISO-8859-1', SystemConfig::getValue('sCommunityAddress'));
        $this->sCommunityCityEncoded = iconv('UTF-8', 'ISO-8859-1', SystemConfig::getValue('sCommunityCity'));
        $this->sCommunityStateEncoded = iconv('UTF-8', 'ISO-8859-1', SystemConfig::getValue('sCommunityState'));
    }
    ...
    public function header(): void
    {
        ...
        if (($this->PageNo() > 1) || ($bDirUseTitlePage == false)) {
            ...
            $this->Cell(
                ...
                10,
                $this->sCommunityNameEncoded . ' - ' . gettext('Directory'),
                1,
                0,
                'C'
            );
    ...
    public function titlePage(): void
    {
        ...
        $sContact = sprintf(
            "%s\n%s, %s  %s\n\n%s\n\n",
            $this->sCommunityAddressEncoded,
            $this->sCommunityCityEncoded,
            $this->sCommunityStateEncoded,
            SystemConfig::getValue('sCommunityZip'),
            SystemConfig::getValue('sCommunityPhone')
        );
