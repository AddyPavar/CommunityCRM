...
use CommunityCRM\Authentication\AuthenticationProviders\APITokenAuthentication;
use CommunityCRM\Authentication\AuthenticationProviders\IAuthenticationProvider;
...
class AuthenticationManager
{
    ...
    public static function getForgotPasswordURL(): string
    {
        ...
        // since they likely will not want users attempting to reset CommunityCRM passwords
