...
class CommunityCRMRelease
{
    ...
    public function equals(CommunityCRMRelease $b): bool
    {
        return $this->MAJOR === $b->MAJOR && $this->MINOR === $b->MINOR && $this->PATCH === $b->PATCH;
    }

    public function compareTo(CommunityCRMRelease $b): int
    {
    ...
    public function getDownloadURL(): string
    {
        foreach ($this->rawRelease['assets'] as $asset) {
            if ($asset['name'] == 'CommunityCRM-' . $this->rawRelease['name'] . '.zip') {
