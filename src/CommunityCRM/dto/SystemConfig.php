...
class SystemConfig
{
    ...
    private static function buildConfigs(): array
    {
        return [
            ...
            'aDisallowedPasswords'                 => new ConfigItem(15, 'aDisallowedPasswords', 'text', 'password,god,jesus,community,christian', gettext('A comma-separated list of disallowed (too obvious) passwords.')),
            ...
            'iCommunityLatitude'                      => new ConfigItem(45, 'iCommunityLatitude', 'number', '', gettext('Latitude of the community, used to center the Google map')),
            'iCommunityLongitude'                     => new ConfigItem(46, 'iCommunityLongitude', 'number', '', gettext('Longitude of the community, used to center the Google map')),
            ...
            'bRegistered'                          => new ConfigItem(999, 'bRegistered', 'boolean', '0', gettext('CommunityCRM has been registered.  The CommunityCRM team uses registration information to track usage.  This information is kept confidential and never released or sold.  If this field is true the registration option in the admin menu changes to update registration.')),
            ...
            'sCommunityName'                          => new ConfigItem(1003, 'sCommunityName', 'text', '', gettext('Community Name')),
            'sCommunityAddress'                       => new ConfigItem(1004, 'sCommunityAddress', 'text', '', gettext('Community Address')),
            'sCommunityCity'                          => new ConfigItem(1005, 'sCommunityCity', 'text', '', gettext('Community City')),
            'sCommunityState'                         => new ConfigItem(1006, 'sCommunityState', 'text', '', gettext('Community State')),
            'sCommunityZip'                           => new ConfigItem(1007, 'sCommunityZip', 'text', '', gettext('Community Zip')),
            'sCommunityPhone'                         => new ConfigItem(1008, 'sCommunityPhone', 'text', '', gettext('Community Phone')),
            'sCommunityEmail'                         => new ConfigItem(1009, 'sCommunityEmail', 'text', '', gettext('Community Email')),
            'sHomeAreaCode'                        => new ConfigItem(1010, 'sHomeAreaCode', 'text', '', gettext('Home area code of the community')),
            ...
            'sTaxReport3'                          => new ConfigItem(1013, 'sTaxReport3', 'text', 'If you have any questions or corrections to make to this report, please contact the community at the above number during business hours, 9am to 4pm, M-F.', gettext('Verbage for bottom line of tax report.')),
            ...
            'sConfirm1'                            => new ConfigItem(1019, 'sConfirm1', 'text', 'This letter shows the information we have in our database with respect to your family.  Please review, mark-up as necessary, and return this form to the community office.', gettext('Verbage for the database information confirmation and correction report')),
            'sConfirm2'                            => new ConfigItem(1020, 'sConfirm2', 'text', 'Thank you very much for helping us to update this information.  If you want on-line access to the community database please provide your email address and a desired password and we will send instructions.', gettext('Verbage for the database information confirmation and correction report')),
            ...
            'sConfirm4'                            => new ConfigItem(1022, 'sConfirm4', 'text', '[  ] I no longer want to be associated with the community (check here to be removed from our records).', gettext('Verbage for the database information confirmation and correction report')),
            ...
            'sDirectoryDisclaimer1'                => new ConfigItem(1028, 'sDirectoryDisclaimer1', 'text', "Every effort was made to ensure the accuracy of this directory.  If there are any errors or omissions, please contact the community office.\n\nThis directory is for the use of the people of", gettext('Verbage for the directory report')),
            ...
            'bDirLetterHead'                       => new ConfigItem(1030, 'bDirLetterHead', 'text', '../Images/community_letterhead.jpg', gettext('Community Letterhead path and file')),
            ...
            'sZeroGivers3'                         => new ConfigItem(1033, 'sZeroGivers3', 'text', 'If you have any questions or corrections to make to this report, please contact the community at the above number during business hours, 9am to 4pm, M-F.', gettext('Verbage for bottom line of tax report.')),
            'sCommunityChkAcctNum'                    => new ConfigItem(1034, 'sCommunityChkAcctNum', 'text', '', gettext('Community Checking Account Number')),
            ...
            'sCommunityCountry'                       => new ConfigItem(1047, 'sCommunityCountry', 'choice', '', '', '', json_encode(['Choices' => Countries::getNames()], JSON_THROW_ON_ERROR)),
            ...
            'sCloudURL'                            => new ConfigItem(2003, 'sCloudURL', 'text', 'http://demo.communitycrm.io/', gettext('CommunityCRM Cloud Access URL')),
            ...
            'sCommunityWebSite'                       => new ConfigItem(2013, 'sCommunityWebSite', 'text', '', gettext("Your Community's Website")),
            'sCommunityFB'                            => new ConfigItem(2014, 'sCommunityFB', 'text', '', gettext("Your Community's Facebook Page")),
            'sCommunityTwitter'                       => new ConfigItem(2015, 'sCommunityTwitter', 'text', '', gettext("Your Community's X Page")),
            ...
            'bHSTSEnable'                          => new ConfigItem(20142, 'bHSTSEnable', 'boolean', '0', gettext('Require that this CommunityCRM Database is accessed over HTTPS')),
            ...
            'bEnabledEducationInitiative'                 => new ConfigItem(2051, 'bEnabledEducationInitiative', 'boolean', '1', gettext('Enable Education Initiative left menu.')),
            ...
            'sNotificationsURL'                    => new ConfigItem(2057, 'sNotificationsURL', 'text', 'https://raw.githubusercontent.com/CommunityCRM/CRM/Notifications/notifications.json', gettext('CommunityCRM Central Notifications URL')),
            'sGreeterCustomMsg1'                   => new ConfigItem(2058, 'sGreeterCustomMsg1', 'text', '', gettext('Custom message for community greeter email 1, max 255 characters')),
            'sGreeterCustomMsg2'                   => new ConfigItem(2059, 'sGreeterCustomMsg2', 'text', '', gettext('Custom message for community greeter email 2, max 255 characters')),
            ...
            's2FAApplicationName'                  => new ConfigItem(2070, 's2FAApplicationName', 'text', gettext('CommunityCRM'), gettext('Specify the application name to be displayed in authenticator app')),
    ...
    {
        return [
            gettext('Community Information') => ['sCommunityName', 'sCommunityAddress', 'sCommunityCity', 'sCommunityState', 'sCommunityZip', 'sCommunityCountry', 'sCommunityPhone', 'sCommunityEmail', 'sHomeAreaCode', 'sTimeZone', 'iCommunityLatitude', 'iCommunityLongitude', 'sCommunityWebSite', 'sCommunityFB', 'sCommunityTwitter'],
            ...
            gettext('Enabled Features')   => ['bEnabledFinance', 'bEnabledEducationInitiative', 'bEnabledEvents', 'bEnabledCalendar', 'bEnabledFundraiser', 'bEnabledEmail', 'bEnabledMenuLinks'],
            ...
            gettext('Community Services')    => ['iPersonConfessionFatherCustomField', 'iPersonConfessionDateCustomField'],
