...
class SystemURLs
{
    ...
    {
        $supportURLs = [
            'HttpsTask'                     => 'https://github.com/CommunityCRM/CRM/wiki/SSL',
            'CheckExecutionTimeTask'        => 'https://github.com/CommunityCRM/CRM/wiki/PHP-Max-Execution-Time',
            'SecretsConfigurationCheckTask' => 'https://github.com/CommunityCRM/CRM/wiki/Secret-Keys-in-Config.php',
            'UnsupportedPaymentDataCheck'   => 'https://github.com/CommunityCRM/CRM/wiki/Finances',
            'UnsupportedDepositCheck'       => 'https://github.com/CommunityCRM/CRM/wiki/Finances',
        ...
        if (array_key_exists($topic, $supportURLs)) {
            ...
            return 'https://github.com/CommunityCRM/CRM/wiki';
        }
    }
