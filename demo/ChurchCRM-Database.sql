...
--
-- Host: database	Database: communitycrm
-- ------------------------------------------------------
-- Server version 	11.2.2-MariaDB-1:11.2.2+maria~ubu2204
-- Date: Fri, 08 Mar 2024 11:58:50 -0500
...
--
-- Table structure for table `community_location_person`
--
...
--
-- Dumping data for table `community_location_person`
--

LOCK TABLES `community_location_person` WRITE;
/*!40000 ALTER TABLE `community_location_person` DISABLE KEYS */;
SET autocommit=0;
/*!40000 ALTER TABLE `community_location_person` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `community_location_person` with 0 row(s)
--

--
-- Table structure for table `community_location_role`
--
...
--
-- Dumping data for table `community_location_role`
--

LOCK TABLES `community_location_role` WRITE;
/*!40000 ALTER TABLE `community_location_role` DISABLE KEYS */;
SET autocommit=0;
/*!40000 ALTER TABLE `community_location_role` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `community_location_role` with 0 row(s)
--
...
SET autocommit=0;
INSERT INTO `config_cfg` VALUES (10,'aFinanceQueries','28,30,31,32'),(21,'sDefaultCity','Kansas City'),(22,'sDefaultState','MO'),(23,'sDefaultCountry','United States'),(27,'sSMTPHost','crmEmailServer:1025'),(28,'bSMTPAuth','1'),(29,'sSMTPUser','c58d4ec1a5a021'),(30,'sSMTPPass','3cfab2ee59990c'),(45,'iCommunityLatitude','39.1111974'),(46,'iCommunityLongitude','-94.5838009'),(48,'bHideFriendDate',''),(49,'bHideFamilyNewsletter',''),(50,'bHideWeddingDate',''),(51,'bHideLatLon',''),(52,'bUseDonationEnvelopes',''),(58,'bUseScannedChecks',''),(65,'sTimeZone','America/Detroit'),(67,'bForceUppercaseZip',''),(72,'bEnableNonDeductible',''),(80,'bEnableSelfRegistration','1'),(999,'bRegistered',''),(1003,'sCommunityName','Main St. Cathedral'),(1004,'sCommunityAddress','123 Main St'),(1005,'sCommunityCity','Kansas City'),(1006,'sCommunityState','MO'),(1007,'sCommunityZip','64106'),(1008,'sCommunityPhone','555 123 4234'),(1009,'sCommunityEmail','demo@communitycrm.io'),(1010,'sHomeAreaCode','555'),(1014,'sTaxSigner','Elder Joe Smith'),(1016,'sReminderSigner','Elder Joe Smith'),(1025,'sConfirmSigner','Elder Joe Smith'),(1027,'sPledgeSummary2','as of'),(1028,'sDirectoryDisclaimer1','Every effort was made to insure the accuracy of this directory.  If there are any errors or omissions, please contact the community office.This directory is for the use of the people of'),(1034,'sCommunityChkAcctNum','111111111'),(1035,'bEnableGravatarPhotos','1'),(1037,'sExternalBackupType','WebDAV'),(1046,'sLastIntegrityCheckTimeStamp','20240307-203649'),(1047,'sCommunityCountry','United States'),(2010,'bAllowEmptyLastName',''),(2017,'bEnableExternalCalendarAPI',''),(2045,'bPHPMailerAutoTLS',''),(2046,'sPHPMailerSMTPSecure',''),(2050,'bEnabledMenuLinks',''),(2060,'IncludeDataInNewPersonNotifications',''),(2061,'bSearchIncludeFamilyCustomProperties',''),(2062,'bBackupExtraneousImages',''),(2064,'sLastSoftwareUpdateCheckTimeStamp','20240307-203650'),(2065,'bAllowPrereleaseUpgrade',''),(2069,'bRequire2FA',''),(2071,'bSendUserDeletedEmail',''),(20142,'bHSTSEnable','');
...
SET autocommit=0;
INSERT INTO `events_event` VALUES (1,2,'Education Initiative Class Changes','This is when the students move to new classes','','2016-11-20 12:30:00','2016-11-20 13:30:00',0,'Education Initiative',NULL,NULL,NULL,NULL),(2,1,'Christmas Service','christmas service','','2016-12-24 22:30:00','2016-12-25 01:30:00',0,'Community Service',NULL,NULL,NULL,NULL),(3,2,'Summer Camp','Summer Camp','','2017-06-06 09:30:00','2017-06-11 09:30:00',0,'Education Initiative',NULL,NULL,NULL,NULL);
...
SET autocommit=0;
INSERT INTO `event_types` VALUES (1,'Community Service','10:30:00','weekly','Sunday','','2016-01-01',1,NULL),(2,'Education Initiative','09:30:00','weekly','Sunday','','2016-01-01',1,NULL);
...
/*!50013 DEFINER=`communitycrm`@`%` SQL SECURITY DEFINER */
...
-- Dump completed on: Fri, 08 Mar 2024 11:58:51 -0500
